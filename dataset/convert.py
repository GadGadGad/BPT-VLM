...
source_path = "./FGVCAircraft"
target_path = "./FGVCAircraft_Gen"
...
f = json.load(open(source_path+"/split_zhou_FGVCAircraft.json","r",encoding="utf-8"))
print(f)
...
for i in range(len(f["train"])):
    ...
    shutil.copy(source_path+"/fgvc-aircraft-2013b/data/images/"+f["train"][i][0], target_path+"/image_data/"+f["train"][i][-1]+"/"+f["train"][i][0].split("/")[-1])
...
for i in range(len(f["test"])):
    ...
    shutil.copy(source_path+"/fgvc-aircraft-2013b/data/images/"+f["test"][i][0], target_path+"/image_data/"+f["test"][i][-1]+"/"+f["test"][i][0].split("/")[-1])
